...
public class Bme280 {
  ...
  public Bme280(Properties props, MqttManager mqttManager) {
    this.mqttManager = mqttManager;
    this.temperatureTopic = props.getProperty("temperatureTopic");
    this.humidityTopic = props.getProperty("humidityTopic");
  }

  public void init() throws IOException, UnsupportedBusNumberException, InterruptedException {
    if (temperatureTopic == null || humidityTopic == null) {
      return;
    }
    // Create I2C bus
